...
# Read FD and Facc files
FD_file="FD_prob.csv"
Facc_file="Facc_prob.csv"

FD = np.genfromtxt(FD_file, delimiter=',')
Facc=np.genfromtxt(Facc_file, delimiter=',')
Area=np.zeros(grid_size*grid_size)


# setting border FD which is not in OCN FD
FD[0,1:grid_size]=64
FD[:grid_size-1,0]=16
FD[grid_size-1,0:grid_size-1]=4
FD[1:grid_size,grid_size-1]=1
